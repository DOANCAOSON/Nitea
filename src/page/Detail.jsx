    ...
    <div className="w-[100%] lg:w-[1200px] flex justify-center mt-[56px] sm:mt-[102px] lg:mt-[102px] mx-[auto] ">
      <div className="w-[100%]">
          ...
          <div className=" gap-x-[28px] px-[20px] lg:p-[0px]">
            <div className="text-left  lg:col-span-4">
              <div className="flex items-center justify-center h-[20px] gap-x-[8px] mb-[8px]">
                <div className="text-colorBlackbland mb-[3px] text-center">7/9/2023</div>
                <div className="h-[100%] w-[1px] bg-colorBlack"></div>
                <div className="text-textmainstream">Sự kiện</div>
              </div>
              <div>
                <div className="text-colorBlack text-2xl font-semibold mb-[64px] text-[28px] leading-[39px] lg:text-[40px] sm:text-[40px]  text-center">
       ...
       <div className="mb-[80px] w-[100%] lg:w-[790px] mx-auto">
          <div className="text-[40px] leading-[56px] text-colorBlack font-semibold mb-[24px]  lg:px-[20px] sm:px-[20px]">
            Giới thiệu
          </div>
          <div className="mb-[48px]">
            <div>
              <p className="">
                Thông tin chi nhánh mới của thương hiệu trà sữa Nitea toạ lạc ngay tại trung tâm Đà Nẵng đã khiến giới trẻ háo hức săn đón. Càng háo hức hơn khi Nitea quyết định dành tặng 100 ly trà sữa miễn phí vào ngày khai trương. Ngay từ 9h sáng, hàng dài các tín đồ trà sữa đã xếp hàng ...F
              </p>
            </div>
          </div>
          ...
          <div className="text-[40px] leading-[56px] text-colorBlack font-semibold mb-[20px]  lg:px-[20px] sm:px-[20px]">
            Kết bài
          </div>
        ...
        <div className="mb-[116px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2  lg:gap-[29px] sm:lg:gap-[29px] gap-y-[40px]  rounded-lg  px-[20px] ">
            <Link to="/detail" className=" w-[100%] md:w-[100%] lg:w-[100%]   ">
            ...
            <Link className=" w-[100%] md:w-[100%] lg:w-[100%]   ">
              ...
              <div>
                <div className="text-colorBlack text-2xl font-semibold mb-[16px]">
                Món mới cùng Nitea – Ưu đãi đặc chỉ có tại ngày mở bán món mới !!!
                </div>
                <div>
                  <p className="text-colorBlack text-base font-normal mb-[16px]">
                    Thông tin chi nhánh mới của thương hiệu trà sữa Nitea toạ
